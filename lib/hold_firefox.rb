...
if RUBY_PLATFORM =~ /linux/i
  ...
  Selenium::WebDriver::Firefox::Binary.path = Selenium::WebDriver::Firefox::Binary.path = Pathname.new(File.dirname(__FILE__)).join('..', 'ext', 'hold_firefox', 'Firefox.app', 'Contents', 'MacOS', 'firefox-bin').to_s
end
